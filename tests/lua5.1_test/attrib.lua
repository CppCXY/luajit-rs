...
-- FIXME(implicit-return): a main chunk whose last statement is an
-- expression call returns nil instead of the statement value, so the
-- recursive require in C.lua yields true (the load-in-progress marker)
-- instead of 25. Blocked.
-- assert(require"C" == 25)
-- assert(require"C" == 25)
AA = nil
try('B', 'B.lua', true)
