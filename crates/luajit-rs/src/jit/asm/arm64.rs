...
impl<'a> Asm<'a> {
    ...
    fn fetch_fp(&mut self, r: IRRef, pinned: u32) -> Result<u8, TraceError> {
        ...
        if r >= REF_BIAS {
            ...
            self.code
                .mov64(RSCRATCH, super::super::exec::const_bits(&self.tr.ir, r));
    ...
    fn gpr_load_ref(&mut self, rd: u8, r: IRRef) {
        if r >= REF_BIAS {
            ...
            self.code
                .mov64(rd, super::super::exec::const_bits(&self.tr.ir, r));
        }
    }
    ...
    fn emit(mut self) -> Result<(McodeArea, u32, Vec<(u32, u32)>), TraceError> {
        ...
        self.code
            .mov64(RSCRATCH, super::super::exec::exit_base_cell_addr());
